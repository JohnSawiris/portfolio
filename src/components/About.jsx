...
const About = (props) => (
  <div className="about">
    ...
    <div className="about-content">
      ...
      I moved to Portland, OR in 2014 from Cairo, Egypt. I gained experience working in customer service and technical support teams. In late 2015, I decided to learn website development. Learning new technologies and languages requires skills I already had, such as problem solving, attention to detail, and an open mindedness. I recently graduated from CSS/REACT track at Epicodus and I completed a two month internship at Trailhead marketing. These experiences have prepared me to an expert at frontend web development.
        </p>
    </div>
    <div className="about-content">
